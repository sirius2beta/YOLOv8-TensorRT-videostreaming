...
def main():
	...
	in_pipeline1 = 'videotestsrc ! video/x-raw, format=YUY2, width=640, height=480, framerate=30/1 !\
	...
	in_pipeline2 = 'v4l2src device=/dev/video0 ! video/x-raw, format=YUY2, width=640, height=480, framerate=30/1 !\
						videoconvert ! appsink'
	...
	detectengine2.setPipeline(in_pipeline1, out_pipeline1)
	detectengine1.setPipeline(in_pipeline2, out_pipeline2)
